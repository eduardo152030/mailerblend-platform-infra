...
Deployed on the target host as:
...
Restart a Service (Example: Prometheus + Alertmanager)
...
Syncs services/infra-prom → /opt/infra-prom
...
Check containers
ssh root@192.168.1.110 "docker ps --format 'table {{.Names}}\t{{.Status}}\t{{.Ports}}'"
